...
with st.sidebar:
    st.header("🔑 API Keys")
    xai_key = st.text_input("xAI API Key (Grok)", type="password", value=st.secrets.get("XAI_API_KEY", ""))
    st.caption("Get free key → [console.x.ai](https://console.x.ai)")
    
    st.header("ℹ️ About")
    st.info("• Uses CoinGecko (free) + Grok-4 (xAI)\n• Scores all 10 criteria you listed\n• Educational tool only — NOT financial advice")
